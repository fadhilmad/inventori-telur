        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card card-primary card-outline">
                    <form class="form-horizontal" method="POST" action="{{ route('master-data.user.update', $user->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="inputPassword3" placeholder="Nama" name="name" value="{{ $user->name }}">
                                    @error('name')
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-info" dusk="btn-user-update">Simpan</button>
                        </div>
                        <!-- /.card-footer -->
                    </form>
                </div>
