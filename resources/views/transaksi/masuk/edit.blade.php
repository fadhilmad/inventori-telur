        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card card-primary card-outline">
                    <form class="form-horizontal" method="POST" action="{{ route('transaksi.masuk.update', $masuk->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-info" dusk="btn-tmasuk-update">Simpan</button>
                        </div>
                        <!-- /.card-footer -->
                    </form>
                </div>
